...
![Figura 1. Esquema general de una red neuronal artificial. Fuente: Carballar.com](GAN.jpg)

Las redes neuronales son una función matemática compuesta por capas (Ver. Img), cuyo objetivo es aproximar una relación entre entrada y salida. El funcionamiento de las redes neuronales artificiales se basa en el ajuste continuo de sus parámetros internos, principalmente los pesos y los sesgos. 
